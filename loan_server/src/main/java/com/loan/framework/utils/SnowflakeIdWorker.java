    ...
    public synchronized long nextId() {
        ...
        try {
            ...
            if (null != ip && !"".equals(ip)) {
                ...
                // 截取IP地址的二进制后5位为datacenterId，后5-10位为workerId
                datacenterId = Long.parseLong(binaryString.substring(binaryString.length() - 5, binaryString.length()), 2);
                workerId = Long.parseLong(binaryString.substring(binaryString.length() - 10, binaryString.length() - 5),2);
            }

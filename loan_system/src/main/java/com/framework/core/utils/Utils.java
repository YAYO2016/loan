...
public class Utils {
	...
	public static String Md5(String inStr) {
		...
		try {
			...
			logger.info(CommonUtils.getLogInfoTemp(e.toString()));
			logger.error(CommonUtils.getLogInfoTemp(e.getMessage()));
			return "";
		}
    ...
    public static void main(String args[]) {  
    	logger.info(CommonUtils.getLogInfoTemp(Utils.MD5("QWE")));
    	//logger.info(CommonUtils.getLogInfoTemp(Utils.Md5("4035bbc636d3f53363b5a1209c3ffe1b"));
    }
